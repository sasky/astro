...
function p8_update_layout() {
  ...
  if (
    ...
    p8_playarea.style.marginTop = (p8_allow_mobile_menu ? 32 : 8) + "px";
...
function p8_run_cart() {
  ...
  e.src = "/pico8/" + window.pico8src + ".js";
  e.id = "e_script";
  ...
  if (p8_touch_detected) {
    ...
    window.onhashchange = function () {
      if (window.location.hash.search("playing") < 0) window.location.reload();
    };
  }
...
window.onload = function () {
  ...
  document.getElementById("p8b_sound").addEventListener("click", () => {
    p8_give_focus();
    p8_create_audio_context();
    Module.pico8ToggleSound();
  });
  document.getElementById("p8b_close").addEventListener("click", () => {
    p8_close_cart();
  });
  document.getElementById("p8_container").addEventListener("click", () => {
    p8_create_audio_context();
    p8_run_cart();
  });
  document.getElementById("p8b_controls").addEventListener("click", () => {
    p8_give_focus();
    Module.pico8ToggleControlMenu();
  });
  document.getElementById("p8b_pause").addEventListener("click", () => {
    p8_give_focus();
    Module.pico8TogglePaused();
    p8_update_layout_hash = -22;
  });
  document.getElementById("p8b_sound").addEventListener("click", () => {
    p8_give_focus();
    p8_create_audio_context();
